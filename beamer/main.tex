...
\section{The Schrodinger }

\begin{frame}
    \frametitle{Setup: distances, spins, coordinates}
    \begin{itemize}
...
\begin{frame}
    \frametitle{The equation (TISE Hamiltonian)}
    \begin{itemize}
...
\begin{frame}
    \frametitle{Fermi--Dirac statistics \& antisymmetry}
    \begin{itemize}
...
\begin{frame}
    \frametitle{Exponential decay of wavefunction}
    \begin{itemize}
...
\begin{frame}
    \frametitle{The Psiformer Ansatz (overview)}
    \begin{itemize}
...
\begin{frame}
    \frametitle{Dissecting the Ansatz}
    \begin{itemize}
...
\begin{frame}
    \frametitle{Jastrow factor form (parallel/antiparallel spins)}
    \begin{itemize}
