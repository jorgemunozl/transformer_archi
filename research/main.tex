...
Additionally, the HuggingFace Transformers library \cite{wolf-etal-2020-transformers} provides a modular reference for attention layers, layer norms, initialization schemes, and efficient training utilities.
